# Available .CONSTRUCTION One-Word Domains (9,225)
...
**Public extract:** 9,227 rows · **Live catalog:** 9,225 domains
...
- `construction.csv` — public CSV extract (9,227 rows)
- `construction.json` — public JSON extract (9,227 rows)
...
| only.construction     | available | $15.99    | $50.99        | 110            | 46     | 4      | name.com                                                  |
...
| info.construction     | resell    | —         | —             | 80             | 51     | 4      | NameCheap, Inc.                                           |
...
| ----------------------- | ------------------------------------------------ |
| 9,227-row public sample | 9,225 live domains                               |
...
> Unique Domains. *Available .CONSTRUCTION One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
